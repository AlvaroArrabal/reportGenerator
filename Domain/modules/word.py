...
dic = { "2G CDR CS (%)":['Degradación puntual','Degradaciones repetitivas en '],
        "2G CSSR CS (%)":['Degradación puntual','MIRAR HUELLA en ','Al no haber llamadas iniciadas este KPI se ve degradado'],
        "2G CSSR PS (%)":['Degradación puntual','MIRAR HUELLA en'],
        ...
        "2G Speech disconnections":['Degradación puntual','Valores elevados en '],
        "3G CDR CS (%)":['Degradación puntual','Degradaciones repetitivas en '],
        "3G CSSR CS (%)":['Degradación puntual','MIRAR HUELLA en','Al no haber llamadas iniciadas este KPI se ve degradado'],
        "3G CSSR PS (%)":['Degradación puntual','MIRAR HUELLA en'],
        ...
        "4G CSSR (VoLTE) (%)":['Degradación puntual','MIRAR HUELLA en','Al no haber llamadas iniciadas este KPI se ve degradado'],
        "4G CSSR PS (%)":['Degradación puntual','MIRAR HUELLA en'],
        ...
        'CA in Primary Cell':['Valores correctos','Sin valores de CA en '],
        'CA in Secondary Cell':['Valores correctos','Sin valores de CA en '],
